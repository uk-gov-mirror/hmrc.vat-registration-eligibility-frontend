...
class InvolvedInOtherBusinessViewSpec extends YesNoViewBehaviours {
  ...
  def createView = () => involvedInOtherBusiness(frontendAppConfig, form, NormalMode)(fakeRequest, messages)

  def createViewUsingForm = (form: Form[_]) => involvedInOtherBusiness(frontendAppConfig, form, NormalMode)(fakeRequest, messages)

  "InvolvedInOtherBusiness view" must {
